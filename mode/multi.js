...
function torn(){
  if(turn == 1){
    document.getElementById("tomb").innerHTML = "Player 1 Turn";
  }
  else if (turn == 2) {
    document.getElementById("tomb").innerHTML = "Player 2 Turn";
  }
...
function begining1(){
  ...
  else if (document.tic.sqr1.value == '     ' && turn == 2) {
...
function begining2(){
  if(document.tic.sqr2.value == '     ' && turn == 1)
  {
  ...
  else if (document.tic.sqr2.value == '     ' && turn == 2) {
...
function begining3(){
  if(document.tic.sqr3.value == '     ' && turn == 1)
  {
  ...
  else if (document.tic.sqr3.value == '     ' && turn == 2) {
...
function begining4(){
  if(document.tic.sqr4.value == '     ' && turn == 1)
  {
  ...
  else if (document.tic.sqr4.value == '     ' && turn == 2) {
...
function begining5(){
  ...
  else if (document.tic.sqr5.value == '     ' && turn == 2) {
...
function begining6(){
  if(document.tic.sqr6.value == '     ' && turn == 1)
  {
  ...
  else if (document.tic.sqr6.value == '     ' && turn == 2) {
...
function begining7(){
  if(document.tic.sqr7.value == '     ' && turn == 1)
  {
  ...
  else if (document.tic.sqr7.value == '     ' && turn == 2) {
...
function begining8(){
  if(document.tic.sqr8.value == '     ' && turn == 1)
  {
  ...
  else if (document.tic.sqr8.value == '     ' && turn == 2) {
...
function begining9(){
  if(document.tic.sqr9.value == '     ' && turn == 1)
  {
  ...
  else if (document.tic.sqr9.value == '     ' && turn == 2) {
...
function reset()
{
  ...
  turn = 1;
  moveCount = 0;
  document.getElementById("tomb").innerHTML="Let's Play Again";
}
